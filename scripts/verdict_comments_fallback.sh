...
# Original path: templates/ci/.github/workflows/_verdict_comments_fallback.sh  (now lives at: scripts/verdict_comments_fallback.sh)
...
HELPER="${WORKSPACE}/scripts/verdict_from_comment.py"
